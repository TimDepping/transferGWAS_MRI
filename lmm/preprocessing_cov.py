...
def main():
    ...
    parser.add_argument('--indiv', type=str,
                        help='Path to subset of individuals')
    parser.add_argument('--add_cov', nargs=2, action='append',
                        help='Additional covariates as key-value pairs (as in `--add_cov 123-0.0 mytrait`)')
    parser.add_argument('--output', type=str,
                        default='covariates.txt', help='Output filename')
